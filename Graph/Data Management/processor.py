...
def process_layers(cities, districts, administrativeDistricts, federalStates, all_geometries):
    ...
    cities = {"ID":ids_c, "Name": cities.GEN_x, "NameD": cities.GEN_y, "Centroid": centroids_c, "Area": areas_c, "Geometry": cities.geometry_y}
    districts = {"ID":ids_d, "Name": districts.GEN_x, "NameAD": districts.GEN_y, "Centroid": centroids_d, "Area": areas_d, "Geometry": districts.geometry_y}
    administrativeDistricts = {"ID":ids_a, "Name": administrativeDistricts.GEN_x, "NameFS": administrativeDistricts.GEN_y, "Centroid": centroids_a, "Area": areas_a, "Geometry": administrativeDistricts.geometry_y}
    federalStates = {"ID":ids_f, "Name": federalStates.GEN, "Centroid": centroids_f, "Area": areas_f, "Geometry": federalStates.geometry}
